function visualize(X_history, R_history, f_history, params)
    L = params.body_l / 2;
    W = params.body_w / 2;
    H = params.body_h / 2;
    ...
    % --- 현재 날짜/시간 기반 폴더 생성 ---
    % =========================================================================
    timestamp = datestr(now, 'yyyymmdd_HHMMSS'); % 예: 20260403_155127
    ...
    disp(['[' save_dir '] 폴더를 생성하고 저장을 시작합니다...']);
    ...
    disp(['모든 결과가 [' save_dir '] 폴더에 성공적으로 저장되었습니다!']);
end